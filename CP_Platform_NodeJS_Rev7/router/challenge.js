...
router.post("/sendCode", function (req, res) {
  //Problem.findById(req.params.id, function (err, foundProblem) {
   // sendCode(req, res, req.body.code, req.body.lang, foundProblem)
    //res.render("problems/edit", { problem: foundProblem })
  //})
  sendCode(req, res, req.body.code, req.body.lang, req.body.problem)
})
...
router.post("/problem", function (req, res) {
  ...
  const testingInput = req.body.testingInput;
  const sampleInputOne = req.body.sampleInputOne;
  const sampleOutputOne = req.body.sampleOutputOne;
  const sampleInputTwo=req.body.sampleInputTwo;
  const sampleOutputTwo = req.body.sampleOutputTwo;
  ...
  const newChallenge = {
    ...
    sampleInputOne:sampleInputOne,
    sampleOutputOne:sampleOutputOne,
    sampleInputTwo:sampleInputTwo,
    sampleOutputTwo:sampleOutputTwo,
    solution:solution
...
//CODING PAGE route show one problem each
router.get("/:id",
...
function sendCode(req, res, code, lang,id,callback) {
  console.log(id)
  Problem.findById(mongoose.Types.ObjectId(id), function(error, oneproblem) {
    console.log(oneproblem)
    var input = oneproblem.testingInput
